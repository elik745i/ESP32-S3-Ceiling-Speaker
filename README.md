...
- Default ESP32-S3 HACS asset: `esp32s3-notifier-hacs-v0.1.17.bin`
...
Release asset names for `v0.1.17`:
...
- [release-assets/v0.1.17/release-notes.md](release-assets/v0.1.17/release-notes.md)
