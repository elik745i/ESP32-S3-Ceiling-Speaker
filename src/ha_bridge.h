...
struct PlaybackCommand {
    ...
    int8_t motorChannelIndex = -1;
    bool motorForward = true;
    uint32_t motorDurationMs = 0;
    int8_t motorLimitInputIndex = -1;
};
...
String discoveryPayloadSwitch(const SettingsBundle& settings, const char* objectId, const char* name, const char* stateTopic, const char* commandTopic, const char* valueTemplate, const char* icon = nullptr, const String& configurationUrl = String(), const char* payloadOn = "ON", const char* payloadOff = "OFF", bool optimistic = false);
String discoveryPayloadNumber(const SettingsBundle& settings, const char* objectId, const char* name, const char* stateTopic, const char* commandTopic, int minValue, int maxValue, int step, const char* unit, const char* icon = nullptr, const String& configurationUrl = String(), const char* valueTemplate = nullptr);
